...
| `composition` | `false` | Experimental tracing API and version-2 source annotations. Config only; when true, supersedes `sourceAnnotations`. See [Component tracing API](COMPOSITION-API.md). |
