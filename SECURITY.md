...
- Anything out of `.env.local` or another `.env` file appearing in a response.
- `.astro-dev-edit.json` written at anything other than `0600`, including for the moment between a write and its rename.
